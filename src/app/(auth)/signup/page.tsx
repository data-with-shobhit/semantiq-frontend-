    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          ...
          <p className="font-mono text-white/50 text-xs uppercase tracking-widest mt-4">START WITH SEMANTIQ.</p>
        </div>
        ...
        <div className="bg-transparent border border-white/20 p-10 flex flex-col gap-8">
          ...
          <p className="text-center text-white/50 text-xs font-mono uppercase tracking-widest">
            ...
            <Link href="/signin" className="text-white hover:text-red-500 underline transition-colors">
              SIGN IN
            </Link>
          </p>
        </div>
